...
{
	/// <summary>
	/// Records the outcome of a method executed during the run of a Processor.
	/// </summary>
	public class MethodOutcome
	{
		...
		/// </summary>
		public ProcessorMethod Method { get; private set; }
		...
		/// </summary>
		public MethodOutcome(ProcessorMethod method, TimeSpan duration, Exception ex)
		{
			Method = method;
			Exception = ex;
			Duration = duration;
		...
		public MethodOutcome(ProcessorMethod method, TimeSpan duration, Error error)
		{
			Method = method;
			Error = error;
			Duration = duration;
