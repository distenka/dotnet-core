...
namespace Distenka.Client
{
    ...
    public class Run
    {
        ...
        /// <summary>
        /// The UTC date/time the Processor was enqueued.
        /// </summary>
        public DateTime EnqueuedAt { get; set; }
        /// <summary>
        /// The username of who enqueued the Processor.
        /// </summary>
        ...
        public class ProcessInfo
        {
            ...
            /// <summary>
            /// The package name where the Processor can be found.
            /// </summary>
            /// <example>MyAwesomePackage</example>
            public string Package { get; set; }
            /// <summary>
            /// The package/Processor version.
            /// </summary>
            /// <example>1.0.0</example>
            public string Version { get; set; }
            /// <summary>
            /// The fully qualified type name of the Processor.
            /// </summary>
            /// <example>My.Namespace.HelloWorld</example>
            public string Type { get; set; }
            /// <summary>
            /// The short name of the Processor.
            /// </summary>
