...
{
	public class DiagnosticProcessor : Processor<DiagnosticConfig, DiagnosticItem>
	{
		...
		public DiagnosticProcessor(DiagnosticConfig config)
			: base(config) { }
		...
		public override Task InitializeAsync()
		{
			...
			if (Config.ThrowExceptionInInitializeAsync)
				throw new DiagnosticProcessException(ProcessorMethod.InitializeAsync, "Exception thrown because Config.ThrowExceptionInInitialize is true.");
		...
		public override IAsyncEnumerable<DiagnosticItem> GetItemsAsync()
		{
			...
			if (Config.ThrowExceptionInGetItemsAsync)
				throw new DiagnosticProcessException(ProcessorMethod.GetItemsAsync, "Exception thrown because Config.ThrowExceptionInGetItemsToProcess is true.");
		...
		public override Task<string> GetItemIdAsync(DiagnosticItem item)
		{
			if (Config.ThrowExceptionInGetItemIdAsync)
				throw new DiagnosticProcessException(ProcessorMethod.GetItemIdAsync, "Exception thrown because Config.ThrowExceptionInGetItemsAsync is true.");
		...
		public override async Task<Result> ProcessAsync(DiagnosticItem item)
		{
			...
			if (Config.ThrowExceptionInProcessAsync)
				throw new DiagnosticProcessException(ProcessorMethod.ProcessAsync, "Exception thrown because Config.ThrowExceptionInProcess is true.");
		...
		public override Task<object> FinalizeAsync(Disposition disposition)
		{
			...
			if (Config.ThrowExceptionInFinalizeAsync)
				throw new DiagnosticProcessException(ProcessorMethod.FinalizeAsync, "Exception thrown because Config.ThrowExceptionInFinalize is true.");
